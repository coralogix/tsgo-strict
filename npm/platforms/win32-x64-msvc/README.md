# @coralogix/tsgo-strict-win32-x64-msvc

This package ships the prebuilt `tsgo-strict` CLI binary and N-API addon for **Windows x64 (MSVC)**. It is an optional dependency of
